...
parser.add_argument('--root_dir', default=r'E:\笔记\2024秋\MULTI_MEDIA\project\action-recognition-video-audio-master\action-recognition-video-audio-master', type=str)
